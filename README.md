...
```
composer require digvijay-elevati/invisible-recaptcha
```
...
```
Elevati\InvisibleReCaptcha\InvisibleReCaptchaServiceProvider::class,
```
...
In controller, use:
```php
$data['captcha'] = new \Elevati\InvisibleReCaptcha\InvisibleReCaptcha(
...
$captcha = new \Elevati\InvisibleReCaptcha\InvisibleReCaptcha($siteKey, $secretKey, $options);
